...
{
    /// <summary>
    /// EventEmitter class from node:events<br />
    /// Some members may not be implemented for the underlying Javascript object.<br/>
    /// For example: the Javascript object may support Off but not RemoveListener
    ...
    public class EventEmitter : JSObject
    {
        ...
        // On, Once, Off, and RemoveListener that support using Action with auto reference handling
        ...
        /// <param name="type"></param>
        /// <param name="listener"></param>
        public void On<T1, T2, T3>(string type, Action<T1, T2, T3> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info))
            {
        ...
        /// Add an event handler that will be called at most once
        /// </summary>
        public void Once<T1, T2, T3>(string type, Action<T1, T2, T3> listener) => Once(type, new ActionCallback<T1, T2, T3>(listener, true));
        /// <summary>
        /// Remove an event 
        /// </summary>
        public void RemoveListener<T1, T2, T3>(string type, Action<T1, T2, T3> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info)) return;
            info.RefCount--;
            RemoveListener(type, info.Callback);
        ...
        /// Remove an event 
        /// </summary>
        public void Off<T1, T2, T3>(string type, Action<T1, T2, T3> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info)) return;
            info.RefCount--;
            Off(type, info.Callback);
        ...
        /// <param name="type"></param>
        /// <param name="listener"></param>
        public void On<T1, T2, T3, T4>(string type, Action<T1, T2, T3, T4> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info))
            {
        ...
        /// Add an event handler that will be called at most once
        /// </summary>
        public void Once<T1, T2, T3, T4>(string type, Action<T1, T2, T3, T4> listener) => Once(type, new ActionCallback<T1, T2, T3, T4>(listener, true));
        /// <summary>
        /// Remove an event 
        /// </summary>
        public void RemoveListener<T1, T2, T3, T4>(string type, Action<T1, T2, T3, T4> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info)) return;
            info.RefCount--;
            RemoveListener(type, info.Callback);
        ...
        /// Remove an event 
        /// </summary>
        public void Off<T1, T2, T3, T4>(string type, Action<T1, T2, T3, T4> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info)) return;
            info.RefCount--;
            Off(type, info.Callback);
        ...
        /// <param name="type"></param>
        /// <param name="listener"></param>
        public void On<T1, T2, T3, T4, T5>(string type, Action<T1, T2, T3, T4, T5> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info))
            {
                info = new CallBackInfo { Callback = new ActionCallback<T1, T2, T3, T4, T5>(listener) };
                CallBackInfos[listener] = info;
            }
            info.RefCount++;
            On(type, info.Callback);
        ...
        /// Add an event handler that will be called at most once
        /// </summary>
        public void Once<T1, T2, T3, T4, T5>(string type, Action<T1, T2, T3, T4, T5> listener) => Once(type, new ActionCallback<T1, T2, T3, T4, T5>(listener, true));
        /// <summary>
        /// Remove an event 
        /// </summary>
        public void RemoveListener<T1, T2, T3, T4, T5>(string type, Action<T1, T2, T3, T4, T5> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info)) return;
            info.RefCount--;
            RemoveListener(type, info.Callback);
        ...
        /// Remove an event 
        /// </summary>
        public void Off<T1, T2, T3, T4, T5>(string type, Action<T1, T2, T3, T4, T5> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info)) return;
            info.RefCount--;
            Off(type, info.Callback);
        ...
        /// <param name="type"></param>
        /// <param name="listener"></param>
        public void On<T1, T2, T3, T4, T5, T6>(string type, Action<T1, T2, T3, T4, T5, T6> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info))
            {
                info = new CallBackInfo { Callback = new ActionCallback<T1, T2, T3, T4, T5, T6>(listener) };
                CallBackInfos[listener] = info;
            }
            info.RefCount++;
            On(type, info.Callback);
        ...
        /// Add an event handler that will be called at most once
        /// </summary>
        public void Once<T1, T2, T3, T4, T5, T6>(string type, Action<T1, T2, T3, T4, T5, T6> listener) => Once(type, new ActionCallback<T1, T2, T3, T4, T5, T6>(listener, true));
        /// <summary>
        /// Remove an event 
        /// </summary>
        public void RemoveListener<T1, T2, T3, T4, T5, T6>(string type, Action<T1, T2, T3, T4, T5, T6> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info)) return;
            info.RefCount--;
            RemoveListener(type, info.Callback);
        ...
        /// Remove an event 
        /// </summary>
        public void Off<T1, T2, T3, T4, T5, T6>(string type, Action<T1, T2, T3, T4, T5, T6> listener)
        {
            if (!CallBackInfos.TryGetValue(listener, out CallBackInfo? info)) return;
            info.RefCount--;
            Off(type, info.Callback);
